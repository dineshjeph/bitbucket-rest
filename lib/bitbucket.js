...
/*******************************************************************************************
 * Repository Details, Branches, Forks
 ******************************************************************************************/
...
/*******************************************************************************************
 * Repository Sevice Hooks
 ******************************************************************************************/

BitBucket.prototype.getRepoHooks = function (repository, cb) {
    ...
    var self = this;
    var url = self.getUrl('repo.hooks.list', repository);
...
BitBucket.prototype.getRepoHookContent = function (repository, cb) {

    if (!repository.repo_slug) { return cb(new Error('Repository slug is required.'), null); }
    if (!repository.owner) { return cb(new Error('Repository owner is required.'), null); }
    if (!repository.id) { return cb(new Error('Service Hook id is required.'), null); }
    if (!cb) { return cb(new Error('Callback is required.'), null); }

    var self = this;
    var url = self.getUrl('repo.hooks.content', repository);
...
BitBucket.prototype.addRepoHook = function (repoDeploy, cb) {
    ...
    var self = this;
    var url = self.getUrl('repo.hooks.add', repoDeploy);
...
BitBucket.prototype.updateRepoHook = function (repoDeploy, cb) {
    ...
    var self = this;
    var url = self.getUrl('repo.hooks.update', repoDeploy);
...
BitBucket.prototype.deleteRepoHook = function (repository, cb) {
    ...
    var self = this;
    var url = self.getUrl('repo.hooks.delete', repository);
